...
function CourseGrade(props: { courseName: string; grade: string }) {
  return (
    <div className="group flex justify-between items-center border-b last:border-b-0 border-b-mono-200 py-2 px-4 hover:bg-mono-150 cursor-pointer overflow-hidden">
